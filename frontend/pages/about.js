        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <div className="singles_abouts_boxs">
                <div className="abouts_thumb">
                  <img src="assets/images/about/abouts-1.png" alt />
                  <div className="about-inner-content">
                    <div className="abouts_titles">
                      <h3>Empowering traders with innovative. </h3>
            ...
            <div className="col-lg-6 col-md-6">
              <div className="singles_abouts_boxs">
                <div className="abouts_thumb">
                  <img src="assets/images/about/abouts-2.png" alt />
                  <div className="abouts_titles upper">
                    <h3>Revolutionizing the trading world, one algorithm. </h3>
                    <div className="abouts_icons">
                      <a href="#">
                        <i className="fas fa-angle-right" />
                      </a>
              ...
              <div className="dreamit-icon-list">
                <ul>
                  <li>
                    ...
                    <span>Lorem Ipsum Communicate orthogonal process </span>
                  </li>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span>
                      Lorem Ipsum Professionally grow cutting-edge paradigms{" "}
                    </span>
                  </li>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                ...
                <div className="tab">
                  ...
                  <Tab.Content className="tab_content">
                    <Tab.Pane eventKey={"t1"} className="tabs_item">
                      <img
                        src="assets/images/resource/img1.png"
                        alt="business image"
                      />
                      <ul className="tabs-inner-list">
                        ...
                        <li>
                          <i className="fas fa-check" />
                          <span>Lorem than unique Idea.</span>
                        </li>
                      </ul>
                    </Tab.Pane>{" "}
                    {/* / tabs_item */}
                    <Tab.Pane eventKey={"t2"} className="tabs_item">
                      <img src="assets/images/resource/img2.png" alt="Image" />
                      <ul className="tabs-inner-list">
                        <li>
                          <i className="fas fa-check" />
                          <span>Lorem ipsum dolor sit amet, consectetur.</span>
                    ...
                    <Tab.Pane eventKey={"t3"} className="tabs_item">
                      <img src="assets/images/resource/img3.png" alt="Image" />
                      <ul className="tabs-inner-list">
                        <li>
                          <i className="fas fa-check" />
                          <span>Lorem ipsum dolor sit amet.</span>
          ...
          <div className="row testi-rotate align-items-center">
            <div className="col-lg-7 col-md-6">
              <div className="consen-section-title white pb-50">
                <h5> Testimonials </h5>
                <h2> Quantlab Algo Trusted Customers </h2>
                <h2>
                  {" "}
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="single_team">
                <div className="single_team_thumb1">
                  <img src="assets/images/resource/team2.jpeg" alt="image" />
                </div>
                <div className="single_team_content">
                  <div className="team-title">
                    <h4>Krishna Dasari</h4>
                    <span>CEO</span>
                  </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single_team">
                <div className="single_team_thumb1">
                  <img src="assets/images/resource/team1.jpeg" alt="image" />
                </div>
                <div className="single_team_content">
                  <div className="team-title">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single_team">
                <div className="single_team_thumb1">
                  <img src="assets/images/resource/team3.jpeg" alt="image" />
                </div>
                <div className="single_team_content">
                  <div className="team-title">
                    <h4>Sridhar Dasari</h4>
                    <span>CEO</span>
                  </div>
                  <div className="single_team_icon">
                    <a href="#">
          ...
          <div className="row">
            <div className="col-lg-6 col-md-12">
              <div className="consen-section-title white pb-1 mb-1">
                <h5 style={{ color: "#ff3c00" }}> process </h5>
                <h2>
                  {" "}
                  Freequently Asked{" "}
                  <span style={{ color: "#ff3c00" }}> Question </span>
                </h2>
              ...
              <div className="dreamit-icon-list">
                <ul>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span> What is Algo Trading? </span>
                  </li>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span>How does Quantlab-Algo help with Trading? </span>
                  </li>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span>
                      {" "}
                      Can i Create my own Trading algorithms on the platform?{" "}
                    </span>
                  </li>
                  <li>
                    <i className="bi bi-arrow-right-circle" />{" "}
                    <span> Is my Data Secure on Quantlab Algo? </span>
                  </li>
                </ul>
              </div>
